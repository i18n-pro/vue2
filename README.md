...
English | [简体中文](https://github.com/i18n-pro/vue2/blob/v2.0.0-alpha.3/README_zh-CN.md)
...
* with$ = true
   ...
   * [![Open in StackBlitz](https://developer.stackblitz.com/img/open_in_stackblitz_small.svg "Open in StackBlitz")](https://stackblitz.com/github/i18n-pro/vue2-demo/tree/main?file=README.md)
* with$ = false
...
* Current Library
   * [Quick Start](https://github.com/i18n-pro/vue2/blob/v2.0.0-alpha.3/docs/dist/USAGE.md)
   * [API](https://github.com/i18n-pro/vue2/blob/v2.0.0-alpha.3/docs/dist/API.md)
   * [Changelog](https://github.com/i18n-pro/vue2/blob/v2.0.0-alpha.3/docs/dist/CHANGELOG.md)
* i18n-pro
