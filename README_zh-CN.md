...
[English](https://github.com/i18n-pro/vue2/tree/v2.0.0-alpha.3#readme) | 简体中文
...
* 当前库
   * [快速上手](https://github.com/i18n-pro/vue2/blob/v2.0.0-alpha.3/docs/dist/USAGE_zh-CN.md)
   * [API](https://github.com/i18n-pro/vue2/blob/v2.0.0-alpha.3/docs/dist/API_zh-CN.md)
   * [更新日志](https://github.com/i18n-pro/vue2/blob/v2.0.0-alpha.3/docs/dist/CHANGELOG_zh-CN.md)
* i18n-pro
